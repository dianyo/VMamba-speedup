...
echo "Running base"
python3 main_no_dist.py --cfg configs/vssm/vmambav2_base_224.yaml --data-path /joe/data/ImageNet-Zip --output /tmp/ --resume ckpt/vssm_base_0229_ckpt_epoch_237.pth --zip --throughput > quatermap_results/vmamba_outputs/vmambav2v_base_224_throughput.log 2>&1
...
python3 main_no_dist.py --cfg configs/vssm/vmambav2_base_224.yaml --data-path /joe/data/ImageNet-Zip --output /tmp/ --resume ckpt/vssm_base_0229_ckpt_epoch_237.pth --zip --throughput > quatermap_results/vmamba_outputs/quatermap_vmambav2v_base_224_throughput.log 2>&1