...
do
    ...
    file_name="quatermap_results/vmamba_outputs/${QUATERMAP_STRATEGY}_vmambav2v_base_224_freq_${i}_flops.log"
...
# echo -e "\n\n==================================="
# echo "Running base with quatermap strategy $QUATERMAP_STRATEGY"
# file_name="quatermap_results/vmamba_outputs/${QUATERMAP_STRATEGY}_vmambav2v_base_224_flops.log"
# python3 main_no_dist.py --cfg configs/vssm/vmambav2_base_224.yaml --data-path /joe/data/ImageNet-Zip --output /tmp/ --resume ckpt/vssm_base_0229_ckpt_epoch_237.pth --zip --flops > $file_name 2>&1
...
#     file_name="quatermap_results/vmamba_outputs/${QUATERMAP_STRATEGY}_vmambav2v_base_224_${QUATERMAP_LAYER}_flops.log"
#     python3 main_no_dist.py --cfg configs/vssm/vmambav2_base_224.yaml --data-path /joe/data/ImageNet-Zip --output /tmp/ --resume ckpt/vssm_base_0229_ckpt_epoch_237.pth --zip --flops > $file_name 2>&1
# done
